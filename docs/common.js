...
async function getUserRoles() {
    ...
    if (!token) return [];
    try {
        const response = await fetch('https://sheared1.github.io/UrlShortener/api/users/get-user-roles', {
...
async function checkEmailVerificationStatus() {
    ...
    try {
        const response = await fetch('https://sheared1.github.io/UrlShortener/api/users/email-verification-status', {
            method: 'GET',
            headers: {
...
async function resendVerificationEmail() {
    ...
    try {
        const response = await fetch('https://sheared1.github.io/UrlShortener/api/email/resend-verification-email', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`
            }
